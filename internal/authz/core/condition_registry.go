...
var conditionRegistry = map[string][]AttributeSpec{
	...
	ActionCreateApprovalRequest:        {AttrResourceEnvironment},
	ActionViewApprovalRequest:          {AttrResourceEnvironment},
	ActionCancelApprovalRequest:        {AttrResourceEnvironment},
	ActionDecideApprovalRequest:        {AttrResourceEnvironment},
